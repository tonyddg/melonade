...
#table(
  ...
  [形容物体], [#aruby("派手")（花哨的）、#aruby("地味")（朴素的）], []
)
...
#table(
  ...
  [（汉字词）], [构成名词，与中文有相同含义], table.cell(colspan: 5)[#aruby("人", i: 2)（#aruby("日本")#aruby("人", i: 2)）、#aruby("家", i: 1)（#aruby("専門")#aruby("家", i: 1)）、#aruby("学")（#aruby("科")#aruby("学")）、#aruby("後", i:2)（#aruby("放課")#aruby("後", i:2)）、#aruby("手")（#aruby("選")#aruby("手")）、#aruby("口")（#aruby("入", i:1)り#aruby("口")）、#aruby("心")（#aruby("決")#aruby("心")）、#aruby("力")（#aruby("電")#aruby("力")）、#aruby("会", i:1)（#aruby("勉強")#aruby("会", i:1)）、#aruby("部")（#lruby("文学")#aruby("部")）], 
...
- る 动词通常会将 る 之前 エ、イ 行的假名暴露在汉字外；违反这一规律的即 る 之前为 エ、イ 行假名的动词一般为 う 动词如 知る、走る
- 动词存在自动词、他动词版本时，他动词版本一般（变形方法，不是识别方法）
  - 将动词结尾换为 eru，如：#aruby("開")く、#aruby("開")ける；#aruby("変わ")る、#aruby("変え")る；#aruby("見")つかる、#aruby("見")つける
  - 将动词结尾换为 su，如：#aruby("壊")れる、#aruby("壊")す；#aruby("帰")る、#aruby("帰")す
...
#table(
  columns: (1fr, ) * 6,
  align: center + horizon,
  [もらう], [あげる], [くれる], [#aruby("送")る], [#aruby("届け")る], [やる],
  [收到], [我给对方礼物], [对方给我礼物], [给出一般物品], [给出且已送达], [给动物物品],
)
...
#table(
  columns: (auto, ) * 2 + (1fr,),
  align: center + horizon,
  table.header()[*打开*][*关闭*][*含义*],
  [#aruby("開", i: 1)く], [#aruby("閉じ")る], [他自动词，表示将折叠在一起的东西或抽象的东西打开（关上）\ 例句：#aruby("傘")を#aruby("開", i: 1)る（打开雨伞），#aruby("心")を#aruby("開", i: 1)く（敞开心扉），#aruby("本")を#aruby("閉じ")る（合上书）],
  [#aruby("開け")る], [#aruby("閉め")る], [他动词，表示将密封的容器或入口的阻挡打开（关严实）\ 例句：#aruby("缶")を#aruby("開け")る（开罐头）、#aruby("手紙")を#aruby("開け")る（撕信封）、#aruby("窓")を#aruby("閉め")る（关窗）],
  [#aruby("開")く], [#aruby("閉ま")る], [自动词，#aruby("開け")る / #aruby("閉め")る 的自动词版本，表示容器打开（关闭）的状态\ 对比：#aruby("店")が#aruby("開")く（容器打开，即店门打开），#aruby("店")を#aruby("開", i: 1)く（抽象打开，即店开业）]
)
