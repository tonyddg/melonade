#import "./index.typ": *
#show: book-page.with(title: "て 形及其应用")
...
#figure(
  table(
    ...
    [动词], [基于#cross-link(p-verb)[过去形]，将末尾的\  た 替换为 て（だ 替换为 で）], [し#hl(1)[た]\ #fruby[たの][頼]ん#hl(1)[だ]], [し#hl(2)[て]\ #fruby[たの][頼]ん#hl(2)[で]], 
...
例如以下句子通过 て 形表示动作顺序，以最后动词 する 的表示具体时态：
- 食堂に 行って、昼ご飯を 食べて、昼寝を する
- 食堂に 行って、昼ご飯を 食べて、昼寝を した

== 进行中与完成时

参考自 #link("https://res.wokanxing.info/jpgramma/teform.html")

这些复杂时态具体含义请根据参考链接内的例句具体体会，此处仅列出变形
